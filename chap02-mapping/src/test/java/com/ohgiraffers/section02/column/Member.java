...
* (두 개 이상 컬럼에 unique 제약조건을 설정하기 위해서 클래스 레벨에서 @Table의 uniqueConstraints 속성에 설정)
* 7. columnDefinition : 직접 컬럼의 ddl을 지정
* 8. length : 문자열 길이, String type 에서만 사용 (default : 255)
* */
...
public class Member {
    ...
    @Temporal(TemporalType.TIMESTAMP) // 날짜 들어갈 때 타입 설정. DateTime
